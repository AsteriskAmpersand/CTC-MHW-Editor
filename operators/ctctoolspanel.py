...
class CTCTools(bpy.types.Panel):
    ...
    bl_idname = "panel.PANEL_PT_mhw_ctc"
    bl_label = "CTC Tools"
    ...
    def draw_edit_matrixes(self, context, layout):
        ...
        self.layout.label(text="Node Linear Structures")
        ...
        self.layout.label(text="Rotation Matrix")
        ...
        self.layout.label(text="Translation Matrix")
        ...
        self.layout.label(text="Unknown Vector")
        ...
        self.layout.label(text="Unknown Bytes")
        ...
        self.layout.label(text="Chain-wide Data")
        col = layout.column(align = True)
        row = col.row(align = True)
    ...
    def draw_create_tools(self, context, layout):
        ...
        self.layout.operator("ctc_tools.chain_from_selection", icon='CONSTRAINT', text="Chain from Selection")
        self.layout.operator("ctc_tools.extend_chain", icon='CONSTRAINT', text="Extend Chain")
        self.layout.operator("ctc_tools.change_target", icon='CONSTRAINT', text="Change Target")
        self.layout.operator("ctc_tools.restart_chain", icon='CONSTRAINT', text="Restart Chain")
        self.layout.operator("ctc_tools.reend_chain", icon='CONSTRAINT', text="Re-End Chain")  
